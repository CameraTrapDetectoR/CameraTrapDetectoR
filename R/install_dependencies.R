...
#' 
#' @return note that all dependencies are installed or need to be installed
#' 
#' @export

install_dependencies <-function(packages=c('torchvision', 'torch', 'magick', 'torchvisionlib',
